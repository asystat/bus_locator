...
public class RecorridoBasicInfoPage extends Page {
    ...
    public RecorridoBasicInfoPage(ModelCallbacks callbacks, String title) {
    ...
    public void getReviewItems(ArrayList<ReviewItem> dest) {
        dest.add(new ReviewItem("Nombre", mData.getString(NAME_DATA_KEY), getKey(), -1));
        dest.add(new ReviewItem("Codigo", mData.getString(CODIGO_DATA_KEY), getKey(), -1));
        dest.add(new ReviewItem("Clase", mData.getString(CLASE_DATA_KEY), getKey(), -1));
        
    }

    @Override
    public boolean isCompleted() {
        return !TextUtils.isEmpty(mData.getString(NAME_DATA_KEY)) && !TextUtils.isEmpty(mData.getString(CODIGO_DATA_KEY));
    }
}
