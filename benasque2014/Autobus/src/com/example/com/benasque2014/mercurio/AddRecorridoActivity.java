...
public class AddRecorridoActivity extends FragmentActivity implements
    ...
    private void guardarRuta(){
    	...
    	if (mWizardModel.findByKey("Periodicidad").getData().getString(SingleFixedBooleanPage.SIMPLE_DATA_KEY,"No").equalsIgnoreCase("Si")){
    		...
    		if (strPeriodicidad!=null){
	    		strPeriodicidad=(datosPer.contains("Lunes")?"1":"0") +":" +
	    				...
	    				(datosPer.contains("Miércoles")?"1":"0") +":" +
	    				(datosPer.contains("Jueves")?"1":"0") +":" +
	    				(datosPer.contains("Viernes")?"1":"0") +":" +
	    				(datosPer.contains("Sábado")?"1":"0") +":" +
